...
- [Scalar product]{style="color:blue"}: 
$$
...
- [$I_{inter}$: between-group inertia]{style="color:red"}(separability of groups)
...
- Merging two groups is associated with an [increase in intra-group variability]{style="color:red"}; it is desired that this increase be [as small as possible]{style="color:red"}.
...
```{r dendro, fig.height=5, fig.width=5,echo=TRUE}
...
```{r dendro2, fig.height=5, fig.width=5, echo=TRUE}
plot(data.ward,hang=-1)
